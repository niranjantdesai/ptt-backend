...
public class PTTBackendTests {
    ...
    public void createUserTest() throws Exception {
        ...
        try {
            ...
            String expectedJson = "{\"id\":" + id + ",\"firstname\":\"John\",\"familyname\":\"Doe\",\"email\":\"john@doe.org\"}";
    ...
    public void updateUserTest() throws Exception {
        ...
        try {
            ...
            String expectedJson = "{\"id\":" + id + ",\"firstname\":\"Tom\",\"familyname\":\"Doe\",\"email\":\"tom@doe.org\"}";
	    JSONAssert.assertEquals(expectedJson,strResponse, false);
            EntityUtils.consume(response.getEntity());
            response.close();
        } finally {
    ...
    public void DeleteUserTest() throws Exception {
        ...
        try {
            ...
            expectedJson = "{\"id\":\"" + deleteid + "\",\"firstname\":\"John\",\"familyname\":\"Doe\",\"email\":\"john@doe.org\"}";
            JSONAssert.assertEquals(expectedJson,strResponse, false);
            EntityUtils.consume(response.getEntity());
            response.close();
    ...
    public void CreateMultipleDeleteOneUserTest() throws Exception {
        ...
        try {
            ...
            String expectedJson2 = "{\"id\":\"" + deleteId + "\",\"firstname\":\"John\",\"familyname\":\"Doe\",\"email\":\"john@doe.org\"}";
    ...
    public void CreateMultipleUpdateOneUserTest() throws Exception {
        ...
        try {
            ...
            String expectedJson = "{\"id\":\"" + updatedId + "\",\"firstname\":\"Jane\",\"familyname\":\"Wall\",\"email\":\"jane@wall.com\"}";
    ...
    public void CreateMultipleDeleteOneProjectTest() throws Exception {
        ...
        try {
            ...
            String expectedJson2 = "{\"id\":" + id + ",\"projectname\":\"Programming\",\"userId\":"+ userId +"}";
            JSONAssert.assertEquals(expectedJson2,strResponse, false);
            EntityUtils.consume(response.getEntity());
            response.close();
...
@Test
    ...
    public void CreateMultipleUpdateOneSessionTest() throws Exception {
        ...
        try {
            ...
            response = response = updateSession(userId, projectId,updatedId, "2019-02-18T20:00Z","2019-02-18T20:45Z",4);
            String expectedJson = "{\"id\":" + id + ",\"startTime\":\"2019-02-18T20:00Z\",\"endTime\":\"2019-02-18T20:45Z\",\"counter\":4 }";
    ...
    private CloseableHttpResponse getUser(String id) throws IOException {
        HttpGet httpRequest = new HttpGet(baseUrl + "/user/" + id);
        httpRequest.addHeader("accept", "application/json");
    ...
    private void deleteAllUsers() throws IOException, JSONException {
        ...
        if (entity != null) {
            ...
            JSONArray userList = new JSONArray(retStr);
            for (int i = 0; i < userList.length(); i++) {
                String id = userList.getJSONObject(i).getString("id");
                deleteUser(id);
            }
        }
        response.close();
